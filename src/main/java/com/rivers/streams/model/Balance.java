...
public class Balance extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Balance\",\"namespace\":\"com.rivers.streams.model\",\"fields\":[{\"name\":\"balanceId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"balance\",\"type\":\"float\"}]}");
   ...
   */
  public static com.rivers.streams.model.Balance.Builder newBuilder() {
    return new com.rivers.streams.model.Balance.Builder();
  }
   ...
   * @return A new Balance RecordBuilder
   */
  public static com.rivers.streams.model.Balance.Builder newBuilder(com.rivers.streams.model.Balance.Builder other) {
    if (other == null) {
      return new com.rivers.streams.model.Balance.Builder();
    } else {
      return new com.rivers.streams.model.Balance.Builder(other);
    }
  }
   ...
   * @return A new Balance RecordBuilder
   */
  public static com.rivers.streams.model.Balance.Builder newBuilder(com.rivers.streams.model.Balance other) {
    if (other == null) {
      return new com.rivers.streams.model.Balance.Builder();
    } else {
      return new com.rivers.streams.model.Balance.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Balance>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.rivers.streams.model.Balance.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.rivers.streams.model.Balance other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.balanceId)) {
        this.balanceId = data().deepCopy(fields()[0].schema(), other.balanceId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rivers.streams.model.Balance.Builder setBalanceId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rivers.streams.model.Balance.Builder clearBalanceId() {
      balanceId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rivers.streams.model.Balance.Builder setAccountId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rivers.streams.model.Balance.Builder clearAccountId() {
      accountId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rivers.streams.model.Balance.Builder setBalance(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rivers.streams.model.Balance.Builder clearBalance() {
